      ...
      >
        ...
        <ScrollView style={{ flex: 1 }}>
          <View style={{ alignItems: "center" }}>
            ...
            >
              Chinub is a mobile application that allows you to explore GitHub
              users in China. With Chinub, you can discover developers and their
              projects in China, helping you connect with fellow developers and
              explore the thriving GitHub community. Key Features: Search for
              GitHub users in China specifically. View user profiles and their
              ...
              with developers China, Chinub is here to make your GitHub
